    ...
    def build_relations(self):
        ...
        for relation in relations_found:
            ...
            if (index_relation in map_relations):
                ...
                for index in range(1,len(map_relations[index_relation])):
                    relation_to_add.add_eq(map_relations[index_relation][index])
                relation_to_add.set_body_definition(replace_var_names(relation) + "\n")
